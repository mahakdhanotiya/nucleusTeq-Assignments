...
export default function ProfilePage() {
  ...
  const fetchProfileData = async () => {
    try {
      ...
      if (data.role === 'DOCTOR') {
        ...
        setValue('experienceYears', data.experience_years || 0);
  ...
  if (loading) {
    return <Spinner label="Loading profile details..." />;
  }
            ...
            <div className="row g-4">
              ...
              <div className="col-lg-6">
                ...
                <div className="d-flex flex-column gap-3">
                  ...
                  {/* License Number */}
                  <div>
                    <label htmlFor="licenseNumber" className="form-label fw-600">License Number</label>
                    <div className="input-group input-icon-group">
                      <span className="input-group-text"><i className="bi bi-journal-check"></i></span>
                      <input
                        type="text"
                  ...
                  {/* Experience Years */}
                  <div>
                    <label htmlFor="experienceYears" className="form-label fw-600">Experience (Years)</label>
                    <div className="input-group input-icon-group">
                      ...
                      <input
                        ...
                        id="experienceYears"
                        {...register('experienceYears', RULES.experienceYears)}
                      />
                    </div>
