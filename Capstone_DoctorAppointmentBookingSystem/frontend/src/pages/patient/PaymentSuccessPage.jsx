  ...
  if (loading) {
    return (
      <div className="d-flex flex-column align-items-center justify-content-center py-5">
        ...
        <p className="text-muted">Loading your booking confirmation...</p>
      </div>
    );
  }
          ...
          {appointment && (
            <div className="card border-0 shadow-sm p-4 mb-4">
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                >
                  {getInitials(appointment.doctor_snapshot.full_name)}
                </div>
                <div>
                  <div className="fw-bold text-dark fs-6">{appointment.doctor_snapshot.full_name}</div>
              ...
              <div className="d-flex justify-content-between py-2">
                ...
                <span className="fw-600">₹{payment?.amount ?? appointment.doctor_snapshot.consultation_fee ?? 0}</span>
              </div>
              <div className="d-flex justify-content-between py-2">
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <span className="fs-5 fw-bold text-success">
                  ₹{payment?.amount ?? appointment.doctor_snapshot.consultation_fee ?? 0}
                </span>
              </div>
            </div>
          )}
