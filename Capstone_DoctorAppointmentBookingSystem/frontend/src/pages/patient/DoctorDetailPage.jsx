...
export default function DoctorDetailPage() {
  ...
  if (loading && !doctor) {
    return <Spinner label="Loading doctor details..." />;
  }
        ...
        <div className="row g-4">
          ...
          <div className="col-12 col-lg-5">
            <div className="card border-0 shadow-sm p-4 text-center h-100">
              <div
                className="doctor-avatar mx-auto mb-3 d-flex align-items-center justify-content-center text-white font-weight-bold shadow-sm overflow-hidden p-0"
                style={{
                  width: '100px',
                  height: '100px',
                  borderRadius: '50%',
              ...
              >
                {doctor.profile_photo_url ? (
                  <img src={doctor.profile_photo_url} alt={doctor.full_name} className="w-100 h-100 object-fit-cover" />
                ) : (
