                ...
                >
                  {paymentLoading ? (
                    ...
                    <>
                      ...
                      Pay ₹{appointment?.payment?.amount ?? appointment?.doctor_snapshot?.consultation_fee ?? 0}
                    </>
                  )}
                </button>
              ...
              {appointment && (
                <>
                  ...
                  <div className="d-flex align-items-center gap-3 mb-4">
                    ...
                    >
                      {appointment.doctor_snapshot.full_name
                        .replace(/^Dr\.\s*/i, '')
                        .split(' ')
                        .map((p) => p[0])
                        .join('')
                    ...
                    <div>
                      <div className="fw-bold text-dark">{appointment.doctor_snapshot.full_name}</div>
                      <div className="text-muted small">{appointment.doctor_snapshot.specialization || 'General Physician'}</div>
                    </div>
                  </div>
                  ...
                  <div className="mb-1">
                    ...
                    {appointment.doctor_snapshot.clinic_address && (
                      <div className="d-flex justify-content-between align-items-center py-2">
                        <span className="text-muted small d-flex align-items-center gap-2">
                  ...
                  <div className="d-flex justify-content-between align-items-center py-2">
                    ...
                    <span className="fw-600">₹{appointment.payment?.amount ?? appointment.doctor_snapshot.consultation_fee ?? 0}</span>
                  </div>
                  <div className="d-flex justify-content-between align-items-center py-2">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <span className="fs-5 fw-bold text-primary">
                      ₹{appointment.payment?.amount ?? appointment.doctor_snapshot.consultation_fee ?? 0}
                    </span>
                  </div>
                </>
              )}
