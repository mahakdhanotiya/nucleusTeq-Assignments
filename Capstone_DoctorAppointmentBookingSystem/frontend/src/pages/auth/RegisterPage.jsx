            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  type="number"
                  min="0"
                  className={`form-control ${errors.consultation_fee ? 'is-invalid' : ''}`}
                  placeholder="500"
              ...
              <div className="col-md-6 mb-3">
                ...
                <input
                  className={`form-control ${errors.clinic_address ? 'is-invalid' : ''}`}
                  placeholder="Cardio Care Clinic"
                  {...register('clinic_address', {
                    required: 'Clinic address is required.',
                    minLength: { value: 2, message: 'Minimum 2 characters.' }
                  })}
                />
                <FieldError message={errors.clinic_address?.message} />
              </div>
            </div>
