      ...
      <div className="card-body p-4 d-flex flex-column justify-content-between">
        <div>
          ...
          <div className="d-flex align-items-start gap-3 mb-3">
            <div className="doctor-avatar p-0 overflow-hidden d-flex align-items-center justify-content-center">
              {profile_photo_url ? (
                <img src={profile_photo_url} alt={full_name} className="w-100 h-100 object-fit-cover" />
              ) : (
